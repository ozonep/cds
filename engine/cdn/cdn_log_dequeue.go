...
func (s *Service) storeLogs(ctx context.Context, itemType sdk.CDNItemType, signature log.Signature, status string, content string, line int64) error {
	...
	if it.Status == item.StatusItemCompleted {
...
func (s *Service) loadOrCreateItem(ctx context.Context, itemType sdk.CDNItemType, signature log.Signature) (*item.Item, error) {
	// Build cds api ref
...
func (s *Service) loadOrCreateItemUnitBuffer(ctx context.Context, itemID string) (*storage.ItemUnit, error) {
